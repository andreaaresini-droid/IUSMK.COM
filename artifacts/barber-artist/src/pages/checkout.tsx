      ...
      <div className="min-h-screen bg-background text-white">
        ...
        <main className="pt-24 pb-20 px-4">
          <div className="max-w-lg mx-auto">
            ...
            >
              <ChevronLeft size={16} /> {tc.backToAcademy}
            </button>
            ...
            <div className="bg-card border border-green-500/20 rounded-2xl overflow-hidden mb-6">
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest text-green-400">{tc.alreadyBadge}</span>
                </div>
            ...
            <div className="bg-card border border-white/10 rounded-2xl p-6 mb-5 text-center space-y-3">
              ...
              <h3 className="text-white font-semibold text-lg">{tc.alreadyTitle}</h3>
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-card border border-white/10 rounded-2xl p-6 mb-5">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-sm uppercase tracking-widest text-muted-foreground mb-2">{tc.accountSection}</h3>
              ...
              <span className="text-xs text-green-400 bg-green-500/10 border border-green-500/20 rounded-full px-3 py-1">{tc.verified}</span>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="bg-card border border-white/10 rounded-2xl p-6 space-y-3">
              <h3 className="font-semibold text-sm uppercase tracking-widest text-muted-foreground">{tc.summary}</h3>
            ...
            >
              {submitting ? (
                ...
                <><CreditCard size={18} /> {tc.payPrefix} €{course.price?.toFixed(2)} {tc.paySuffix}</>
              )}
            </button>
